      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <!-- Profile Image -->
            <?php echo form_open_multipart('mahasiswa/edit/'.$nim.'/'.$foto)?>
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input id="nim" name="nim" type="text" class="form-control" value="<?=$data['nim']?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input id="navbar" name="nama_lengkap" type="text" class="form-control" value="<?=$data['nama_lengkap']?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input id="tahun_masuk" name="tahun_masuk" type="text" class="form-control" value="<?=$data['tahun_masuk']?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <select class="form-control" style="height: 35px" name="prodi">
                      <option value="D3 MI" <?=$data['prodi']=='D3 MI'? 'selected':'';?>>
                        D3 Manajemen Informatika
                      </option>
                      <option value="D4 TI" <?=$data['prodi']=='D4 TI'? 'selected':'';?>>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input id="nomor_telepon" name="nomor_telepon" type="text" class="form-control" value="<?=$data['nomor_telepon']?>">
                  </div>
                </div>
