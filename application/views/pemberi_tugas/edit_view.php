  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Admin/Dosen/Teknisi</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <!-- Profile Image -->
            <?php echo form_open_multipart('pemberi_tugas/edit/'.$nip.'/'.$foto)?>
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input id="nip" name="nip" type="text" class="form-control" value="<?=$data['nip']?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <select name="level" class="form-control" style="height: 35px">
                      <option value="dosen" <?=$data['level']=='dosen'? 'selected':'';?>>Dosen/Teknisi/Admin</option>
